...
class ProjectCard(QFrame):
    ...
    def __init__(self, project: Project, hours_logged: float, is_starred: bool = False):
        ...
        hours_label.setStyleSheet("color: #495057;")
        ...
        crumb_label.setStyleSheet("color: #6c757d; font-size: 10px;")
        ...
        if project.target_hours > 0:
            ...
            target_label.setStyleSheet("color: #6c757d; font-size: 10px;")
...
class HomeScreen(QWidget):
    ...
    def _create_status_bar(self):
        ...
        self.project_count_label.setStyleSheet("color: dimgray;")
        layout.addWidget(self.project_count_label)
        
        layout.addStretch()
        
        self.today_total_label = QLabel("Today: 0.0 hrs")
        self.today_total_label.setStyleSheet("color: dimgray; font-weight: bold;")
